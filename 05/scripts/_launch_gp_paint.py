"""
_launch_gp_paint.py — file interno, usato da run_grease_pencil_paint.bat.
Non modificare. Non eseguire direttamente.
"""
import bpy, os

TARGET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "grease_pencil_video_paint.py")
